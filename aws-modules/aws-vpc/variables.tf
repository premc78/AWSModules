...
variable "retention_in_days" {
  description = "The flow-log log-group retention period in days"
  type        = string
  default     = "90"
}
...
variable "cw_log_dest_arn" {
  description = "The destination ARN log-group in the centralized logging account"
  type        = string
  default     = ""
}
